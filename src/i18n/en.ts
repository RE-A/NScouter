...
export const EN: Record<string, string> = {
  ...
  '이름 바꾸기': 'Rename',
  '이 서버를 부를 이름을 정합니다': 'Give this server a name you will recognize',
  '최근 최대': 'recent max',
  '눈금은 정해 둔 임계입니다': 'The scale comes from the thresholds you set',
  '임계가 없어 최근 관측 최대를 눈금 끝으로 씁니다':
    'No threshold set — the scale ends at the highest value seen recently',
  // ── 이 구간 (응답시간 분포 · 서비스 순위) ──────────────
  '이 구간': 'This range',
  '응답시간 분포': 'Response time distribution',
  '서비스 순위': 'Top services',
  '응답시간 분포와 서비스 순위': 'distribution and top services',
  '펼치면 이 구간의 트랜잭션을 세어 분포와 순위를 냅니다':
    'expand to count this range’s transactions',
  '트랜잭션을 세는 중…': 'counting transactions…',
  '세는 중…': 'counting…',
  '아직 받지 않았습니다': 'not loaded yet',
  '이 구간에 트랜잭션이 없습니다': 'no transactions in this range',
  '이 구간에 서비스 호출이 없습니다': 'no service calls in this range',
  '같은 구간을 다시 셉니다': 'count the same range again',
  '타입 전체': 'whole type',
  '상한에 걸려 앞부분만 셌습니다. 구간을 좁히면 전부 셉니다.':
    'Hit the row cap — only the earlier part was counted. Narrow the range to count all.',
  '이 값보다 느린 건은 상한으로 눌러 셌습니다 — 실제로는 더 느릴 수 있습니다':
    'Anything slower than this was clamped to the cap — the real value may be higher.',
  '횟수': 'Count',
  '합계': 'Total',
  '평균': 'Avg',
  '합계(ms)': 'Total(ms)',
  ...
  '그룹': 'Group',
  '토폴로지': 'Topology',
  '눌러서 이 앱의 트랜잭션 보기': 'click to see this app’s transactions',
  '애플리케이션': 'Applications',
  '인스턴스': 'Instances',
  ...
  '묶기': 'Group by',
  '종류': 'Kind',
  '종류 조건을 풉니다': 'clear the kind filter',
  '오브젝트 종류': 'Object kind',
  '타입': 'Type',
  ...
  '같은 시간축': 'One time axis',
  '마우스를 올리면 그 시각의 값을 봅니다': 'Hover to read the values at that moment',
  '이 구간에 값이 없습니다': 'No values in this range',
  '받는 중…': 'Loading…',
  // '1시간'·'6시간' 은 과거 구간 고르기에 이미 있다. 같은 말을 두 번 적으면 사전이 갈린다.
  '3시간': '3 hours',
